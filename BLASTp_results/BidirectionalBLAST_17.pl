...
use strict;
require "C:/Users/wheat/Documents/coculture_project/common_functions.pl";	#require our script of useful functions
...
open(ABBLOG, ">AbbreviatedLog_17.log") or die "could not open AbbreviatedLog.log, reason $!";

#have an error log
open(ERRORLOG, ">error_17.log") or die "could not open error.log, reason $!";

#have a dedicated full log
open(FULLLOG, ">FullLog_17.log") or die "could not open FullLog.log, reason $!";
...
open(ECBLASTOUT, ">ECBlastInfo_17.csv") or die "could not create/write ECBlastInfo.csv, reason $!";
...
open(BLASTIN, "<BlastSpecs_17.txt") or die "could not open/read BlastSpecs.txt, necessary file for calibrating this program for the target organism, reason: $!";
