...
output=open('FVA_results_ctherm_AVM061.txt','w',buffering=1)
...
fixed_rates = {
    ...
    #tests for essentiality of GTP/ITP cofactor for PFK
    #"R00770":0.0,
    #"R00770a":0.0,
...
in_vivo_yield = 0.176268057
in_vivo_sd = 0.00396071
