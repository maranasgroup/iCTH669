...
output=open('pFBA_results_ctherm_yield_tracking_LL1004.txt','w',buffering=1)
...
#print(str(model.reactions[model.reactions.index("BIOMASS")].lower_bound) + "\n")
#print(str(model.reactions[model.reactions.index("BIOMASS")].upper_bound) + "\n")
